$(function() {
    ...
    var liHasChild = _menu.find('liz.hasChild'),
    ...
    ////////////// 行動版選單切換////////////
    /*-----------------------------------*/
    _body.prepend('<aside class="sidebar"><div class="m_area"></div><div class="menu_overlay"></div></aside>');
    $('header .container').prepend('<button type="button" class="sidebarCtrl">側欄選單</button><button type="button" class="mobile_member_btn">會員專區</button>');
    ...
    function mobileMenu() {
        ...
        if (ww < wwSmall) {
            ...
            $('.member_block .content').hide();
            $('.mpwrap .member_block .content').hide().slideDown(1000);
            // 打開會員專區時
            $('.mobile_member_btn').click(function() {
                _mArea.slideUp();
                _body.removeClass('noscroll');
            })
            $('.member_block .close_memberblock').click(function() {
                $('.member_block .content').slideUp();
            })
        } else {
            /*-----------------------------------*/
